						...
						<form:form class="form-horizontal" role="form"
							...
							<fieldset class="content-group">
								...
								<div class="row">
									...
									<div class="col-xs-2" style="margin-left: -20px">
										<form:select id="tipoPessoaJs"
											path="credenciado.codigoTipoPessoaTransiente"
								...
								<div class="row">
									...
									<div class="col-xs-2" style="margin-left: -20px">
										<form:select path="credenciado.codigoSituacaoTransiente"
								...
								<div class="row">
									...
									<div class="col-xs-2" style="margin-left: -20px">
										<form:input type="text" class="form-control"
											...
											path="credenciado.valorCobradoTransiente"
											cssErrorClass="field_error form-control" />
									</div>
								</div>
							</fieldset>
							...
							<fieldset class="content-group">
								...
								<div class="row">
									...
									<div class="col-xs-4" style="margin-left: -1%">
										<form:select path="especialidade.id" id="inputEspecialidade"
							...
							<fieldset class="content-group">
								...
								<div class="text-right">
									...
									<button type="submit" id="btn-salvar" disabled="disabled"
