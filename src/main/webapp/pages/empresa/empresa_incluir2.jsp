					...
					<div class="page-title">
						<h4>
							<i class="icon-arrow-left52 position-left"></i> <span
								class="text-semibold">Gestão</span> - Empresas - Cadastro
						</h4>
					</div>
				</div>
								...
								<fieldset class="content-group">
									...
									<div class="row">
										...
										<div class="col-xs-2" style="margin-left: -50px">
											<form:input required="true" type="text" class="form-control"
												id="npj"
												placeholder="Informe o numero do documento" path="cnpj"
												cssErrorClass="field_error form-control has-errors" />
									...
									<div class="row">
										...
										<div class="col-xs-2" style="margin-left: -1px">
											<form:input type="text" class="form-control"
												...
												path="dataadesao" cssErrorClass="field_error form-control" />
										</div>
									...
									<div class="row">
										...
										<div class="col-xs-2">
											<form:input type="text" class="form-control" id="inputCpf"
												placeholder="Digite o CPF" path="inscriestadual"
												cssErrorClass="field_error form-control" />
										</div>
										<div class="col-xs-1">
										...
										<div class="col-xs-2" style="margin-left: -1px">
											<form:input type="text" class="form-control" id="inputCpf"
												placeholder="Digite o CPF" path="inscrimunicipal"
												cssErrorClass="field_error form-control" />
										</div>
								...
								<fieldset class="content-group">
									...
									<div class="row">
										...
										<div class="col-xs-5" style="margin-left: -20px">
											<form:input required="true" type="text" class="form-control"
												id="inputNome" placeholder="Digite o nome da rua"
									...
									<div class="row">
										...
										<div class="col-xs-2">
											<form:input required="true" type="text" class="form-control"
												id="inputNome" placeholder="Digite o município"
