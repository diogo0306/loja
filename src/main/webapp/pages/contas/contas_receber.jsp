					...
					<div class="page-title">
						<h4>
							<i class="icon-arrow-left52 position-left"></i> <span
								class="text-semibold">Gestão</span> - Contas a Receber
						</h4>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-heading">
						<h5 class="panel-title">Consultar Contas a Receber</h5>
					...
					<div class="panel-body">
						<form:form method="POST" class="form-horizontal" role="form"
							action="${raiz}contas_receber" modelAttribute="contasReceber">
							...
							<div class="form-group">
								...
								<div class="col-xs-3">
									<form:select id="#" path="codigoTipoContaTransiente"
							...
							<div class="form-group">								
								...
								<div class="col-xs-3">
									<form:select id="#" path="codigoTipoStatusTransiente"
										class="form-control" cssErrorClass="field_error form-control">
										<form:option value="" label="Selecione" />
							...
							<div class="row">
								<div class="col-xs-offset-1 col-xs-6">
									...
									&nbsp; <a href="${raiz}contasReceber/salvar"
						...
						<tbody>
							...
							<c:forEach var="conta" items="${contas}">
								<tr>
									...
									<td><c:out value="${conta.valorPago}" /></td>
