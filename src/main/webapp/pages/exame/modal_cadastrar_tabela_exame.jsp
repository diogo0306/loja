...
<div class="modal fade" id="modalCadastrarTabela">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form:form action="${raiz}tabela_exame/salvar-tabela" method="POST"
					modelAttribute="tabela" class="formulario_acoes"
					id="formCadastrarTabela">

					<div class="divSeparador2">

						<div class="row" id="msgFieldDescricaoRequerido" hidden>
						...
						<div class="row">
							...
							<div class="col-lg-6" style="width: 75%">
								<form:input type="text" class="form-control"
									id="inputNomeTabela" placeholder="Digite o nome" path="nome"
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success"
					onclick="submeterFormModalTabela()">Confirmar</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
