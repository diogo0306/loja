...
<div class="container">
	<div class="page-header">
		<h3>Relatório de Estatística X Vida Útil</h3>
	</div>
	<div class="panel panel-default">
		...
		<div class="divSeparador2">
			...
			<form:form method="POST" class="form-horizontal" role="form" action="${raiz}componentes_vencido_total/gerar" modelAttribute="otdRelatorio">
