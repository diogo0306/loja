...
<div class="container">
	<div class="page-header">
		<h3>Relatório de Potência não consumida</h3>
	</div>
	<div class="panel panel-default">
		...
		<div class="divSeparador2">
			...
			<form:form method="POST" class="form-horizontal" role="form" action="${raiz}potencia_nao_consumida/gerar" modelAttribute="otdRelatorio">
