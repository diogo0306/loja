			...
			<div class="page-header">
					...
					<div class="page-title">
						<h4>
							<i class="icon-arrow-left52 position-left"></i> <span
								class="text-semibold">Gestão</span> - Tabela de Faixas
						</h4>
					</div>
				</div>
				...
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li><a href="${raiz}tabelaFaixas"> Tabela de Faixas</a></li>
			...
			<div class="content">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-heading">
						<h5 class="panel-title">Consultar Tabelas</h5>
					...
					<div class="panel-body">
						<form:form method="POST" class="form-horizontal" role="form"
							action="${raiz}tabelaFaixas" modelAttribute="tabelaFaixa">
							...
							<div class="row">
								<div class="col-xs-offset-1 col-xs-6">
									...
									&nbsp; <a href="${raiz}tabelaFaixa/salvar"
										...
										<ul class="icons-list">
											<li class="dropdown"><a href="#" class="dropdown-toggle"
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a
														href="${raiz}tabelaFaixa/visualizar/${tabela.id}"><i
															class="glyphicon glyphicon-search"></i> Visualizar</a></li>

													<li><a href="${raiz}tabelaFaixa/alterar/${tabela.id}"><i
