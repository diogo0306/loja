				...
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<form:form method="POST" class="form-horizontal" role="form"
							action="${raiz}usuariosLoja" modelAttribute="usuarioLoja">

							<div class="form-group">
								<div class="col-xs-1">
									<label for="field_1">Nome de usuário</label>
								</div>
								<div class="col-xs-5">
									<form:input type="text" class="form-control" id="#"
										placeholder="Digite o nome" path="nomeUsuario" />
								</div>
							</div>
							<div class="row">
								<div class="col-xs-offset-1 col-xs-6">
									<button type="submit" class="btn btn-success abrirJanela">Pesquisar</button>
									&nbsp; <a href="${raiz}usuarioLoja/salvar"
					...
					<table
						...
						<tbody>
							...
							<c:forEach var="usuarioLoja" items="${usuariosLoja}">
								<tr>
									<td><c:out value="${usuarioLoja.nomeUsuario}" /></td>

									<td><c:out
											value="${usuarioLoja.tipoUsuarioLojaEnum.descricao}" /></td>
										...
										<ul class="icons-list">
											<li class="dropdown"><a href="#" class="dropdown-toggle"
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a
														href="${raiz}usuarioLoja/alterar/${usuarioLoja.id}"><i
															class="glyphicon glyphicon-search"></i> Alterar</a></li>

													<li><a
														href="${raiz}usuarioLoja/visualizar/${usuarioLoja.id}"><i
