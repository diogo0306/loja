				...
				<div class="panel panel-flat">
					<div class="panel-body">
						<form:form method="POST" class="form-horizontal" role="form"
							action="${raiz}fornecedores" modelAttribute="fornecedor">
							...
							<div class="row">
								<div class="col-xs-offset-1 col-xs-6">
									...
									&nbsp; <a href="${raiz}fornecedor/incluir"
						...
						<tbody style="font-size: 12px;">
							<c:forEach var="fornecedor" items="${fornecedores}">
								<tr>
									...
									<td style="text-align: center"><c:out value="${fornecedor.valorTransiente}" /></td>
										...
										<ul class="icons-list">
											<li class="dropdown"><a href="#" class="dropdown-toggle"
												...
												<ul class="dropdown-menu dropdown-menu-right">
													<li><a
														href="${raiz}fornecedor/alterar/${fornecedor.id}"><i
